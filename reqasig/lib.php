...
function lis_comreq() {
    ...
    $sql = "SELECT R.id_reqcom AS ACCIONES, 
            ...
            R.cotizacion AS Cotización,
            R.requerimiento AS Requerimiento,
    ...
    $datos = obtener_datos_paginados($sql, $where . " ORDER BY R.id_reqcom DESC", $params, $types, $offset, $regxPag);
