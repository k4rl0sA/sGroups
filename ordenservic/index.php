...
<head>
    ...
    <title> Orden de Servicio || <?php echo APP; ?></title>
...
<body Onload="actualizar();">
        ...
        <div class="top-menu">
            ...
            <section>
                <div class="content content-1">
                    <div class="title txt-center"><h2>Ordenes de Servicio</h2></div>
                    <div class="frm-filter poppins-font" id='<?php echo $mod; ?>-fil'>
                        <div class="input-box">
                            <label for="fprovedor">Proveedor:</label>
                            <input type="text" class="captura" id="fprovedor" name="fprovedor" OnChange="actualizar();">
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <select class='choices-single' id="fciudad" name="fciudad" OnChange="actualizar();">
                ...
                <div class="content content-2">
                    <div class="title txt-center"><h2>Proveedores</h2></div>
    ...
    <script>
        ...
        function grabar(tb = '', ev) {
            ...
            const res = confirm("¿Desea guardar la información del proveedor?");
            if (res) {
                myFetch(ruta_app, `a=gra&tb=${tb}`)
                    ...
                    .catch(error => {
                        ...
                        enqueueMessage('error', "Error al guardar el proveedor.", 7000);
                    });
            }
        }
    </script>
