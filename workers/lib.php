...
function lis_repDiar() {
    ...
    $tabla = "repor_diario";
	$sqltot="SELECT COUNT(*) total  FROM `repor_diario` R LEFT JOIN nove_repdiar N ON R.id_rep = N.idrep LEFT JOIN usuarios U ON R.usu_create = U.id_usuario WHERE " . $where;
 ...
 FROM `repor_diario` R LEFT JOIN nove_repdiar N ON R.id_rep = N.idrep LEFT JOIN usuarios U ON R.usu_create = U.id_usuario";
