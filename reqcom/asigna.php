...
function get_comreq() {
    if ($_POST['id'] == '0') {
        ...
        $id = divide($_POST['id']);
        $sql = "SELECT CTLG(8,R.actividad) 'actividad',R.cotizacion 'cotizacion',R.requerimiento 'requerimiento',C.cliente 'cod_contacto',CO.nombre cod_empresa,O.oficina 'cod_oficina',R.descripcion,R.pendientes  
