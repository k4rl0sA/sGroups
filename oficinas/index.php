...
$tipos=opc_sql("SELECT idcatadeta,descripcion from catadeta where idcatalogo=7 and estado='A' ORDER BY 2",'');
$acc=acceBtns('office');
...
<head>
    ...
    <title> Oficinas || <?php echo APP; ?></title>
...
<body Onload="actualizar();">
        ...
        <div class="top-menu">
            ...
            <section>
                <div class="content content-1">
                    <div class="title txt-center"><h2>Oficinas</h2></div>
                    <div class="frm-filter poppins-font" id='<?php echo $mod; ?>-fil'>
                        <div class="input-box">
                            <label for="foficina">Nombre Oficina:</label>
                            <input type="text" class="captura" id="foficina" name="foficina" OnChange="actualizar();">
                        </div>
                        <div class="input-box">
                            <label for="ftipo">Tipo Oficina:</label>
                            <select class='choices-single' id="ftipo" name="ftipo" OnChange="actualizar();">
    ...
    <script>
        ...
        function grabar(tb = '', ev) {
            ...
            const res = confirm("¿Desea guardar la información de la oficina?");
            if (res) {
                myFetch(ruta_app, `a=gra&tb=${tb}`)
                    ...
                    .catch(error => {
                        ...
                        enqueueMessage('error', "Error al guardar la oficina.", 7000);
                    });
            }
        }
    </script>
